...
public class Homework6Test {
  ...
  public static void main(String[] args) {
    ...
    initTable(table, numBoards);
		N = table.largestP(2*numBoards);
		int n = numBoards;
		int intR =(int)  (N*Math.pow((1-1./N), n));
		expColl = n - N + intR;
		table.printEach();
		System.out.println("n: "+ numBoards);
		System.out.println("number of buckets(N): "+table.largestP(2*numBoards));
		System.out.println("Expected number of collisions: " + expColl);
