...
public class DisjointSets {
  ...
  public void union(int root1, int root2) {
    ...
    root2 = find(root2);
    if(root1 == root2){
      System.out.println("the same root");
      return;
    }
  ...
  public static void main(String[] args) {
    ...
    System.out.println("*testing union of two non-root elems");
    DisjointSets s1 = new DisjointSets(7);
    s1.union(1, 3);
    s1.union(2, 4);
    s1.union(1, 5);
    s1.union(1, 4);
    System.out.println(s1.find(1));
    System.out.println(s1.array[s1.find(1)]);
    System.out.println(s1.find(2));
    System.out.println(s1.array[s1.find(2)]);
    System.out.println(s1.find(5));
    System.out.println(s1.array[s1.find(5)]);
    System.out.println(s1.find(0));
    System.out.println(s1.array[s1.find(0)]);
